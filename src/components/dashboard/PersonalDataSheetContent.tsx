...
type SavedPds = {
  last_name?: string | null; first_name?: string | null; middle_name?: string | null; suffix?: string | null; nickname?: string | null;
    ...
    <div className="pt-3 space-y-3">
      ...
      <Section id="basic" icon={User} title="Basic & Contact Information" subtitle="Name, address, birth details, government IDs" openId={openId} setOpenId={setOpenId}>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
          ...
          <TextField label="Suffix" value={suffix} onChange={setSuffix} placeholder="Jr., Sr., III" />
